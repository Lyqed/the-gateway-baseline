 ...
 * (partial), because the 2026-08-05 correction is a ledger entry, not a
...
export type MatrixSnapshot = {
  /** ISO date the snapshot was frozen, matching a ledger pass. */
  date: string;
...
export const SNAPSHOTS: readonly MatrixSnapshot[] = [
  {
    date: "2026-08-03",
    note: "Second full verification: nine gateways against all twelve checks (108 cells), our own reference row added and scored from the code. Recorded as judged that day: the LiteLLM GB-7 cell reads partial here; the 2026-08-05 correction to no is recorded in the ledger, not rewritten into this snapshot.",
    cells: {
